...
ruta_archivo = 'D://OneDrive - Grupo EPM//3. CENS//0. PIE - PIR - PF//2. Insumos Exp - Rep//1. Reposiciones para habilitar enlaces//Proyectos UC-urbano.xlsx'
...
unidades_constructivas_exp_n2 = [
    ('N2L100', 'red', 'Expansión redes de distribución CENS','Tipo IV','n'),
    ('N2L136', 'red', 'Expansión redes de distribución CENS','Tipo IV','n'),
    ('N2L71', 'sus', 'Expansión redes de distribución CENS','Tipo IV','n'),
    ('N2L72', 'ret', 'Expansión redes de distribución CENS','Tipo IV','n'),
    ('N2L137', 'tie', 'Expansión redes de distribución CENS','Tipo IV','n')]

unidades_constructivas_exp_n3 = [
    ('N3L99', 'red', 'Expansión redes de distribución CENS','Tipo IV','n'),
    ('N3L124', 'red', 'Expansión redes de distribución CENS','Tipo IV','n'),
    ('N3L64', 'sus', 'Expansión redes de distribución CENS','Tipo IV','n'),
    ('N3L65', 'ret', 'Expansión redes de distribución CENS','Tipo IV','n'),
    ('N3L126', 'tie', 'Expansión redes de distribución CENS','Tipo IV','n')]

unidades_constructivas_rep_n2 = [
    ('N2L100', 'red', 'Reposición redes de distribución CENS','Tipo III','n'),
    ('N2L136', 'red', 'Reposición redes de distribución CENS','Tipo III','n'),
    ('N2L71', 'sus', 'Reposición redes de distribución CENS','Tipo III','n'),
    ('N2L72', 'ret', 'Reposición redes de distribución CENS','Tipo III','n'),
    ('N2L137', 'tie', 'Reposición redes de distribución CENS','Tipo III','n')]

unidades_constructivas_rep_n3 = [
    ('N3L99', 'red', 'Reposición redes de distribución CENS','Tipo III','n'),
    ('N3L124', 'red', 'Reposición redes de distribución CENS','Tipo III','n'),
    ('N3L64', 'sus', 'Reposición redes de distribución CENS','Tipo III','n'),
    ('N3L65', 'ret', 'Reposición redes de distribución CENS','Tipo III','n'),
    ('N3L126', 'tie', 'Reposición redes de distribución CENS','Tipo III','n')]
...
for index, row in data_base.iterrows():
    if row['CATEGORIA'] == 'Automatización de Redes (Reconectadores)':
        ...
        if row['NT'] == 'II':
            for uc, formula, proyecto, tipo, Nivel in unidades_constructivas_exp_n2:
                nueva_fila = row.copy()
                nueva_fila['Unidades constructivas'] = uc
            ...
            for uc, formula, proyecto, tipo, Nivel in unidades_constructivas_exp_n3:
                nueva_fila = row.copy()
                nueva_fila['Unidades constructivas'] = uc
        ...
        if row['NT']=='II':
            for uc, formula, proyecto, tipo, Nivel in unidades_constructivas_rep_n2:
                nueva_fila = row.copy()
                nueva_fila['Unidades constructivas'] = uc
            ...
            for uc, formula, proyecto, tipo, Nivel in unidades_constructivas_rep_n3:
                    nueva_fila = row.copy()
                    nueva_fila['Unidades constructivas'] = uc
