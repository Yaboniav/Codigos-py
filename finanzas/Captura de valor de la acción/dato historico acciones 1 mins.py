...
save_directory = r'C:\Users\yaboniav\Documents\Finanzas\Historial de acciones cada 1 min'
...
for company, ticker in companies.items():
    ...
    hist['SMA_35'] = hist['Close'].rolling(window=35).mean()
    # Exponential Moving Average (EMA)
    hist['EMA_12'] = hist['Close'].ewm(span=12, adjust=False).mean()
    hist['EMA_26'] = hist['Close'].ewm(span=26, adjust=False).mean()
    hist['EMA_35'] = hist['Close'].ewm(span=35, adjust=False).mean()
