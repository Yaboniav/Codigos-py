...
headers = [
    ...
    "FDC_DEPENDENCIA", "FDC_EQUIPOTRABAJO", "FDD_CAUSA", "DETALLE_CAUSA", "FDD_CAUSA_CREG",
    "DESCRIPCION_CAUSA_CREG", "PROGRAMADA", "FDD_CAUSA_SSPD", "FDD_EXCLUSION", "FDD_TIPOCARGA",
    "FDD_CONTINUIDAD", "FDD_USUARIOAP", "FDD_AJUSTADO", "FDD_TIPOAJUSTE", "FDD_RADICADO",
    "FDD_APROBADO", "OBJETIVO_INI"
]
...
path = 'D://OneDrive - Grupo EPM//3. CENS//0. PIE - PIR - PF//3. Calidad del servicio//1. DB//2021'
...
csv_filename = "D://OneDrive - Grupo EPM//3. CENS//0. PIE - PIR - PF//3. Calidad del servicio//2. compilado Calidad//2021.csv"
